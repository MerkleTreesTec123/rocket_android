...
public class ExcRechargeRecordFragment extends BaseListFragment<ExcWalletRecord> implements ExcWalletRecordContract.View {
    String mCoinID;
    ExcWalletRecordContract.Presenter mRecordPresenter;

    public static ExcRechargeRecordFragment newInstance(String coinID) {
        Bundle args = new Bundle();
        args.putString("coinID", coinID);
        ExcRechargeRecordFragment fragment = new ExcRechargeRecordFragment();
    ...
    public void onRequest(int page) {
        ...
        mRecordPresenter.fetchWalletRecord(mCoinID, ExcWalletRecordContract.RECORD_TYPE_RECHARGE, page);
    }

    @Override
    public int getItemLayoutResId() {
        return R.layout.exc_wal_item_recharge_record;
    }
