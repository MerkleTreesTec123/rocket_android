 ...
 * C2C 添加/修改微信收款地址
 */
public class WeChatAddressActivity extends BaseActivity implements UploadImageContract.View, C2CUpdatePayAccountContract.View, PayPasswordDialog.InputPayPasswordCallBack {
    ...
    protected int getContentViewLayoutId() {
        return R.layout.c2c_activity_wechat_address;
    }
    ...
    public static void openWeChatAddressActivity(Context context, C2CPayAccount account) {
        Intent intent = new Intent(context, WeChatAddressActivity.class);
    ...
    protected void onCreateViewAfter(Bundle savedInstanceState) {
        ...
        setNavigationCenter(getString(R.string.c2c_wechat));
    ...
    public void onUploadImageSuccess(String fileID, String url, int tag) {
        PictureFileUtils.deleteCacheDirFile(WeChatAddressActivity.this);
        bindQRImage(url);
    }
