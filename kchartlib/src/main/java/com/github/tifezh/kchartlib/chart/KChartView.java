    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setFallColor(array.getColor(R.styleable.KChartView_kc_fall_color, getColor(R.color.chart_red)));
                setRiseColor(array.getColor(R.styleable.KChartView_kc_rise_color, getColor(R.color.chart_green)));
...
//        showLoading();
     ...
     * @param color
     */
    public void setFallColor(int color) {
        mMainDraw.setFallColor(color);
        mVolumeDraw.setFallColor(color);
    }
    ...
    public void setRiseColor(int color) {
        mMainDraw.setRiseColor(color);
        mVolumeDraw.setRiseColor(color);
    }
