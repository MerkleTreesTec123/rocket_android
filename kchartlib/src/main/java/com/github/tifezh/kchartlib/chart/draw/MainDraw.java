...
public class MainDraw implements IChartDraw<ICandle> {
    ...
    private void drawSelector(BaseKChartView view, Canvas canvas) {
        ...
        strings.add(mContext.getString(R.string.kchart_high) + point.getHighPrice());
        strings.add(mContext.getString(R.string.kchart_low) + point.getLowPrice());
        strings.add(mContext.getString(R.string.kchart_open) + point.getOpenPrice());
        strings.add(mContext.getString(R.string.kchart_close) + point.getClosePrice());
