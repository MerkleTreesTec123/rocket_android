...
public class DragPointView extends AppCompatTextView {
    ...
    public OnDragCallback getDragListencer() {
        return dragCallback;
    }

    public void setDragListencer(OnDragCallback dragCallback) {
