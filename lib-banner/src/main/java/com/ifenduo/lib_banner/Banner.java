...
import com.ifenduo.lib_banner.loader.ImageLoaderInterface;
import com.ifenduo.lib_banner.view.BannerViewPager;
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                params.height = mIndicatorSelectedHeight;
                params.width = mIndicatorSelectedWidth;
            } else {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void onPageSelected(int position) {
        ...
        if (bannerStyle == BannerConfig.CIRCLE_INDICATOR ||
                bannerStyle == BannerConfig.CIRCLE_INDICATOR_TITLE ||
                bannerStyle == BannerConfig.CIRCLE_INDICATOR_TITLE_INSIDE) {
            ImageView unSelectedImageView = indicatorImages.get((lastPosition - 1 + count) % count);
            LinearLayout.LayoutParams layoutParams= (LinearLayout.LayoutParams) unSelectedImageView.getLayoutParams();
            layoutParams.width=mIndicatorWidth;
            layoutParams.height=mIndicatorHeight;
            unSelectedImageView.setLayoutParams(layoutParams);
            unSelectedImageView.setImageResource(mIndicatorUnselectedResId);

            ImageView selectedImageView = indicatorImages.get((position - 1 + count) % count);
            LinearLayout.LayoutParams layoutParams_= (LinearLayout.LayoutParams) selectedImageView.getLayoutParams();
            layoutParams_.width=mIndicatorSelectedWidth;
            layoutParams_.height=mIndicatorSelectedHeight;
            selectedImageView.setLayoutParams(layoutParams_);
            selectedImageView.setImageResource(mIndicatorSelectedResId);
    ...
    public void setIndicatorMarginBottom(int bottomMargin) {
        RelativeLayout.MarginLayoutParams layoutParams = (MarginLayoutParams) bottomContainer.getLayoutParams();
