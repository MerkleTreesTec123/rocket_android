    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setFallColor(array.getColor(R.styleable.KLineChartView_kc_fall_color, getColor(R.color.chart_red)));
                setRiseColor(array.getColor(R.styleable.KLineChartView_kc_rise_color, getColor(R.color.chart_green)));
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
                array.recycle();
